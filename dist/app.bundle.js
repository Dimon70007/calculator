...
var funcSelector = function funcSelector(BINDED_RESULT_ACTIONS, BINDED_MEMORY_ACTIONS, BINDED_FIELD_ACTIONS, state) {
  ...
  var resultValue = Number(resultState.arg || resultState.value);
  ...
  return _ref = {}, __WEBPACK_IMPORTED_MODULE_0_babel_runtime_helpers_defineProperty___default()(_ref, NUM, addValue), __WEBPACK_IMPORTED_MODULE_0_babel_runtime_helpers_defineProperty___default()(_ref, COMMA, onceActn), __WEBPACK_IMPORTED_MODULE_0_babel_runtime_helpers_defineProperty___default()(_ref, MEM, function (btnName) {
    ...
    switch (btnName) {
      ...
      case 'btn_n!':
        return setResultAndAddFunc(__webpack_require__.i(__WEBPACK_IMPORTED_MODULE_8__helpers__["e" /* factorial */])(resultValue), btnName, true);
      case 'btn_x^y':
...
var setOper = function setOper(arr, _ref2) {
  ...
  if (multiDivide.includes(oper)) {
    return ['('].concat(__WEBPACK_IMPORTED_MODULE_1_babel_runtime_helpers_toConsumableArray___default()(arr), [arg, ')', oper]);
  }
...
var fieldState = function fieldState() {
  ...
  switch (type) {
    case addOperation:
      return __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_3__helpers__["c" /* setOper */])(state, __WEBPACK_IMPORTED_MODULE_0_babel_runtime_helpers_extends___default()({}, resultState, { val: val }));
    case addFunc:
      return __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_3__helpers__["d" /* addFunction */])(state, payload);
    case clearField:
      return init;
    default:
      return state;
